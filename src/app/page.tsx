    ...
    <div className="bg-white">
      ...
      <section className="relative min-h-screen flex items-end pb-24">
        <div className="absolute inset-0">
          <Image src={getImagePath("/assets/bilde_med_bil.png")} alt="3TS Industriservice" fill className="object-cover" priority />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal direction="left">
              <div className="relative rounded-3xl overflow-hidden aspect-[4/3] shadow-2xl">
                <Image src={getImagePath("/assets/sveising.png")} alt="3TS Industriservice" fill className="object-cover" />
